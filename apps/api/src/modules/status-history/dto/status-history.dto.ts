...
export class CreateStatusHistoryDto {
  ...
  @ApiPropertyOptional({ description: 'Previous pipeline status', enum: ApplicationStatus, example: ApplicationStatus.SAVED })
  @IsOptional()
  @IsEnum(ApplicationStatus)
  fromStatus?: ApplicationStatus;

  @ApiProperty({ description: 'New target pipeline status', enum: ApplicationStatus, example: ApplicationStatus.APPLIED })
  @IsEnum(ApplicationStatus)
  @IsNotEmpty()
...
export class StatusHistoryResponseDto {
  ...
  @ApiPropertyOptional({ enum: ApplicationStatus, example: ApplicationStatus.SAVED })
