...
export class CompaniesController {
  ...
  @ApiResponse({ status: 403, description: 'Forbidden: requires permission company.create' })
  ...
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden: requires permission company.update' })
  @ApiResponse({ status: 404, description: 'Company not found' })
  async update(
    @Param('id') id: string,
  ...
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden: requires ADMIN role and company.delete permission' })
  @ApiResponse({ status: 404, description: 'Company not found' })
